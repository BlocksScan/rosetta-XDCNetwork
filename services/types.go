...
type Client interface {
	...
	PendingNonceAt(context.Context, XDPoSChaincommon.Address) (uint64, error)

	NonceAt(ctx context.Context, account XDPoSChaincommon.Address, blockNumber string) (uint64, error)
