...
const (
	// XDPoSChain network information
	XDPoSChainBlockchain       = "XDPoSChain"
	XDPoSChainMainnetNetWorkId = 50
	XDPoSChainTestnetNetWorkId = 51
	XDPoSChainDevnetNetWorkId  = 551
	ExtraSeal                 = 65
	Epoch                     = 900
